...
The solo variant supplies the bounded utility `score / (abs(score) + 1000)`
for reinforcement learning, including negative production scores. Its raw
production score remains in `scores`.
