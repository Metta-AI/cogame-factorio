...
// setZoom, panBy, panTo, resetView, getTransform, ...). Copied from
// coworld-ctf replay-viewer/static_replay.js; renamed exports, `start`
// takes the replay bytes the page fetched (or falls back to ?replay=), and
// the sim mismatch-tick attribute is gone (nothing is re-simulated here).
(function () {
  'use strict';
  ...
  function createCore(config) {
    ...
    function start(replayBytes) {
      ...
      try {
        worker = new Worker(workerUrl, { name: 'factorio-static-replay' });
